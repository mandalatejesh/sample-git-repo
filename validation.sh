...
if [ $DR_HOST_X == True ]
then
  if [ DR_DISPLAY == null ] || [[ $DR_SAGEMAKER_IMAGE != *"gpu"* ]] || [[ $DR_SAGEMAKER_CUDA_DEVICES != 0 ]] || [[ $DR_ROBOMAKER_CUDA_DEVICES != 0 ]] || [ $DR_DOCKER_STYLE != compose ]
  then
    ...
    echo "DR_SAGEMAKER_IMAGE=5.2.1-gpu, or latest version"
